{<img src="https://travis-ci.com/crystallabs/maildir.cr.svg?branch=master" alt="Build Status" />}[https://travis-ci.com/crystallabs/maildir.cr]
...
Project status: Usable and complete

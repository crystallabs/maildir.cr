...
While the maildir format was created for email, it works well for arbitrary data. This library can read and write any file contents, using the Maildir file and directory structure. And if you want file contents to be automatically serialized/deserialized objects, pluggable serializers are supported as well.

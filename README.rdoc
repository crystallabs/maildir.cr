Version and license: {<img src="https://img.shields.io/github/tag/crystallabs/maildir.cr.svg?maxAge=360" alt="Version" />}[https://github.com/crystallabs/maildir.cr/releases/latest]
...
Build status: {<img src="https://travis-ci.com/crystallabs/maildir.cr.svg?branch=master" alt="Build Status" />}[https://travis-ci.com/crystallabs/maildir.cr]

Project status: [ ] Early stage and development [X] Usable [X] Complete [ ] 

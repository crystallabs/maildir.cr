...
While the maildir format was created for email, it works well for arbitrary data. This library can read and write email messages or any other contents. Pluggable serializers are supported as well.
...
Get a key that uniquely identifies the message

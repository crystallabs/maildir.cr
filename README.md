**Build status**:
[![Build Status](https://github.com/crystallabs/maildir.cr/actions/workflows/ci.yml/badge.svg)](https://github.com/crystallabs/maildir.cr/actions/workflows/ci.yml)
